...
@Composable
fun PreviewVarianPage() {
    // Define some sample data for pilihanRasa
    val samplePilihanRasa = listOf("Original", "Chocolate", "Coffee", "Vanilla", "Macha", "Milky")

    Activity5_multipageTheme {
        VarianPage(
            pilihanRasa = samplePilihanRasa,
