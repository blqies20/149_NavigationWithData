...
fun HomePage (
    ...
    val image = painterResource(id = R.drawable.fremilt)
    Column(modifier = Modifier, verticalArrangement = Arrangement.SpaceBetween) {
        OutlinedCard(
            ...
            Column(horizontalAlignment = Alignment.CenterHorizontally, modifier = Modifier.align(Alignment.CenterHorizontally)) {
                ...
                Text(text = "Thai Tea", color = Color.DarkGray, fontSize = 35.sp, modifier = Modifier.align(Alignment.CenterHorizontally))
                Text(text = "Fremilt", color = Color.DarkGray, fontStyle = FontStyle.Italic, fontSize = 60.sp, fontWeight = FontWeight.Bold)
            }
        }
        Row(
            modifier = Modifier
